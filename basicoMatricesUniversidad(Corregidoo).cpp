...
void despegarResultados (int numeroCalculos, int ganadosFacultad1, int ganadosFacultad2, int ganadosFacultad3);
...
void llamaCiclo()
{
    ...
    do
    {
        ...
        if (opcion == 'n')
        {
            despegarResultados(numeroCalculos, ganadosFacultad1, ganadosFacultad2, ganadosFacultad3);  // Añadir esta línea
            repetir=false;
        }
    } while (repetir);
}
...
float imprimirMatriz(float matriz[NUMERO_ALUMNOS][NUMERO_NOTAS + 1], char alumnos[NUMERO_ALUMNOS][MAXIMA_LONGITUD_CADENA], string nombreFacultad)
{
    ...
    void despegarResultados (int numeroCalculos, int ganadosFacultad1, int ganadosFacultad2, int ganadosFacultad3)
    {
    cout << "El programa se ha calculado " << numeroCalculos << " veces" << endl;
     if (ganadosFacultad1 > ganadosFacultad2 && ganadosFacultad1 > ganadosFacultad3)
     {
         cout << "¿Cual es la mejor facultad?: " << " Ingeniería" << endl;
         cout << "Gano:" << ganadosFacultad1 << " veces" << endl;
     } else if (ganadosFacultad2 > ganadosFacultad1 && ganadosFacultad2 > ganadosFacultad3)
     {
         cout << "¿Cual es la mejor facultad?: " << " Arquitectura" << endl;
         cout << "Gano:" << ganadosFacultad2 << " veces" << endl;
     } else if (ganadosFacultad3 > ganadosFacultad1 && ganadosFacultad3 > ganadosFacultad2)
     {
         cout << "¿Cual es la mejor facultad?: " << " Administración" << endl;
         cout << "Gano:" << ganadosFacultad3 << " veces" << endl;
     } else {
        cout << "Hay un empate entre las facultades." << endl;
    }
